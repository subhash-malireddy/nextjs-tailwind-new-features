...
export default function Page() {
  return (
    <main className="flex min-h-screen flex-col">
      <div className="flex h-20 shrink-0 items-end bg-skin-fill-accent-base p-4 md:h-52">
        <AcmeLogo />
      </div>
      <div className="mt-4 flex grow flex-col justify-center gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 bg-skin-fill-secondary-default px-6 py-10 md:px-20">
