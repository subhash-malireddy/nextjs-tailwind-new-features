// Loading animation
const shimmer =
  "before:absolute before:inset-0 before:-translate-x-full before:animate-[shimmer_2s_infinite] before:bg-gradient-to-r before:from-transparent before:via-[rgba(var(--color-skeleton-gradient-start),0.6)] before:to-transparent";

export function CardSkeleton() {
  return (
    <div
      className={`${shimmer} relative overflow-hidden rounded-xl bg-skin-fill-secondary-default p-2 shadow-sm`}
    >
  ...
  return (
    <div className="mt-6 flow-root">
      <div className="inline-block min-w-full align-middle">
        <div className="rounded-lg bg-skin-fill-secondary-default p-2 md:pt-0">
          ...
          <table className="hidden min-w-full text-gray-900 md:table">
            ...
            <tbody className="bg-skin-fill-teritiary">
              <TableRowSkeleton />
              <TableRowSkeleton />
              <TableRowSkeleton />
              <TableRowSkeleton />
